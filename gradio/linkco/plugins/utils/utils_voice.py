...
def get_voice2text(audio_path: str, language: str = 'Chinese', model_nickname: str = None) -> str:
    """
    把声音文件转换成文本
...
def get_text2voice(text: str, wavFile: str, model_nickname: str = None) -> bool:
    """
    把文本转换成声音文件

from ...main import llm_module, setting, linkco_module_path, split_line_2
...
def get_chat(prompt,
    ...
    # print('【当前使用的模型】', model_nickname)
    # print('【当前使用的模型】: 脑海 RobotMind7B-0.1')
...
def get_example_chat(prompt,
    ...
    example_str = '【示例】\n' + get_example_prompt(example, history)
